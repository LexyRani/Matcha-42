...
export function Home()
{
    ...
    return(
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#EBB3B8]/40 space-y-8 p-6">
            ...
            <h1 className="text-5xl font-bodini font-bold text-black mb-8"> Roocool </h1>
            </div>
            <div className="mb-8 animate-bounce" >
                <Heart className="w-48 h-48 text-primary  fill-current"/>
            </div>         
            <div className="w-full max-w-sm space-y-4 mt-12">
              ...
              <footer className="mt-auto pb-4 font-bodini text-xs text-gray-400">© 2026 Matcha Inc.</footer>
        </div>
    );
}
